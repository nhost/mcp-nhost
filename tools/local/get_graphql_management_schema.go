...
const (
	ToolGetGraphqlManagementSchemaName = "local-get-graphql-management-schema"
	//nolint:lll
	ToolGetGraphqlManagementSchemaInstructions = `Get GraphQL's management schema for an Nhost development project running locally via the Nhost CLI. This tool is useful to manage hasura metadata, migrations, permissions, remote schemas, etc.`
)
